"""
Django settings for projeto13 project.
...
OPENWEATHERMAP_API_KEY = os.getenv('OPENWEATHERMAP_API_KEY', '914d64b83a40e29250139720a0674cf5')
...
WSGI_APPLICATION = 'projeto13.wsgi.application'
